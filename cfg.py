...
flags.DEFINE_boolean('p_relu', True, '')
flags.DEFINE_boolean('aug', True, '')
flags.DEFINE_string('subtype', 'cifar10', '')
flags.DEFINE_string('stand', '128', '')
flags.DEFINE_boolean('bri', False, '')
flags.DEFINE_boolean('con', False, '')
flags.DEFINE_boolean('sat', False, '')
flags.DEFINE_boolean('hue', False, '')
